# Single-column comparison: Lightflux (Williams 2026) vs RRTMGP
...
# `Lightflux.AnalyticBandLongwave` on the same profile and plots
...
# Ordering convention: Lightflux uses top-down (k=1 is TOA). Breeze
